...
After thorough exploration of the [data](https://srujanreddyj.github.io/portfolio/2020/09/26/M5_1.html) and [time-series visualization](https://srujanreddyj.github.io/portfolio/2020/09/26/M5_2.html), now I will try my hand at forecasting methods and predicting the demand for the three states and three products seperately. We will discuss various different approach present, used and develop one model appraoch for forecasting product sales demand time series. Lets get started!!
