...
## Important Facts:
  ...
  * Achieved mAP@0.5:0.95 - 0.495 -- close to be an MVP
...
Then came across some random tweet suggesting build a hobby product that I would like to use. After toiling a lot, suddenly I came across this [applied-ml github](https://github.com/eugeneyan/applied-ml#computer-vision) by Eugene Yan. This a awesome collection of application oriented Machine learning models being used in the industry. In computer vision section, this [airbnb paper](https://medium.com/airbnb-engineering/amenity-detection-and-beyond-new-frontiers-of-computer-vision-at-airbnb-144a4441b72e) caught my eye and I thought this is a cool product I would like to see for myself and at same time I can  learn important and new engineering skills needed for building an end-to-end machine learning model by following this article.

This article was pretty in detail, an almost step by step method one can follow to create a business need machine learning model. As I was learning new aspects of machine learning engineering, I wanted to follow the article step by step and replicate it and achieve similar results.  
